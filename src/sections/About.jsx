      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          <div className="z-10">
            ...
            <p className="subtext">Some introductionary shit</p>
          </div>
        ...
        <div className="grid-default-color grid-2">
            <div className="flex items-center justify-center w-full h-full" ref={grid2Container}>
                ...
                <Card style={{rotate: '-30deg', top: '60%', left: '45%'}} text='GRASP' containerRef={grid2Container}/>
                <Card style={{rotate: '90deg', top: '30%', left: '70%'}} text='DB' containerRef={grid2Container}/>
                <Card style={{rotate: '-45deg', top: '55%', left: '0%'}} text='API' containerRef={grid2Container}/>
                <Card style={{rotate: '20deg', top: '10%', left: '30%'}} text='Design Patterns' containerRef={grid2Container}/>
